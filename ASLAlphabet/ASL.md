...
[!IMPORTANT]
You should run the notebook with your own directory to the data files, yoy can download the dataset from [Kaggle](https://www.kaggle.com/datasets/lexset/synthetic-asl-alphabet)
## Overview
